                        ...
                        {isPolicyOpen &&
                            <span className={styles.cookiePolicyContent}>
                                ...
                                <div className={styles.policyButtonContainer}>
                                    <button className={styles.cookieNotificationAcceptButton} onClick={() => {setConsentedToCookies(true)}}>Accept and Remember My Response 🍪</button>
                                    <button className={styles.cookiePolicyAcknowledgeButton} onClick={() => setIsPolicyOpen(false)}>Dismiss 👍</button>
                                </div>
                            </span>
                        }
                    </div>
